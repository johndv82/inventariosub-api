...
@router.delete("/{movimiento_id}", response_model=InventarioResponse, status_code=200)
...
@router.get("/{inventario_id}", response_model=InventarioResponse, status_code=200)
